...
// encabezados: Nombre | Email | Fecha | Instancia | AE | Intención | Idioma
const SHEET_RANGE = "Descargas!A:G";
...
export async function appendDownloadLog({ name, email, instanceLabel, aeLabel, intentLabel, lang }) {
  if (!SHEET_ID) {
  ...
  await sheets.spreadsheets.values.append({
    ...
    requestBody: {
      values: [
        [name || "", email || "", timestamp, instanceLabel || "", aeLabel || "", intentLabel || "", lang || ""],
      ],
    },
  });
}
